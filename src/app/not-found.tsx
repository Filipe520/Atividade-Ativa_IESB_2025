...
const GoArrowLeft = dynamic(
  () => import("react-icons/go").then((mod) => mod.GoArrowLeft),
  { ssr: false }
);
...
export default function NotFound() {
  return (
    <article className="flex max-md:flex-col justify-center items-center mx-auto bg-white min-[500px]:h-[900px] h-dvh min-sm:py-5">
      ...
      <section className="bg-[url('/imagens/not-found-2.jpg')] bg-center bg-cover bg-no-repeat hidden max-md:hidden md:flex justify-start items-center rounded-r-3xl my-5 md:w-xl h-full mr-5" />
    </article>
  );
}
